...
Из-за невозможности проверить работоспособность сдаю это задание так
Выполнено так, как я считаю оно будет работать корректно

1. Получение нужных элементов из html
2. Проверка на были ли загружены фото до входа
3. Установка слушателя на кнопку и проверка входных значений на соответствие заданию
4. Отправка и получение ответа с url и сохранение ответа в localStorage
5. Функция загрузки и отрисовки картинок в отведенный div
